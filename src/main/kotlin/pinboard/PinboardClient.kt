 ...
 */
class PinboardClient(private var token: String, rt: RestTemplate? = null) {
    ...
    fun deletePost(url: String): Boolean {
    ...
    fun getAllPosts(tag: Array<String>,
                    start: Int = 0,
                    results: Int = -1,
                    fromdt: Date? = null,
                    todt: Date? = null,
    ...
    fun getPosts(url: String? = null, dt: Date? = null, tag: Array<String>? = null, meta: Boolean? = null): Bookmarks {
    ...
    fun getRecentPosts(tag: Array<String>? = null, count: Int? = 15): Bookmarks {
    ...
    fun getNoOfPostsByDate(tag: Array<String>): PostsByDate {
    ...
    fun suggestTagsForPost(url: String): SuggestedTags {
        val params = exchangeParameters("url" to url)
    ...
    fun getUserTags(): Map<String, Int> {
    ...
    fun deleteTag(s: String): Boolean {
...
class Notes(var count: Int? = 0, var notes: Array<Note>?) {
    private constructor() : this(0, arrayOf())
}

class SuggestedTags(val popular: Array<String>?, val recommended: Array<String>?) {
    private constructor() : this(arrayOf(), arrayOf())
}

class Bookmarks(date: Date?, var user: String?, var posts: Array<Bookmark>) {
...
class Bookmark(var href: String?,
...
class PostsByDate(var user: String?, tag: Array<String>?, val dates: Map<Date, Int>?) {
